...
var BSmenu = document.createElement("Div");
	...
	var col_2 = document.createElement("Button");
	    col_2.class = "editPanel";
	    var txt = document.createTextNode(".col-2");
		col_2.appendChild(txt);
	    col_2.className = "tags";
		col_2.style.marginLeft="2px";
	
	var col_3 = document.createElement("Button");
	    col_3.class = "editPanel";
	    var txt = document.createTextNode(".col-3");
		col_3.appendChild(txt);
	    col_3.className = "tags";
		col_3.style.marginLeft="2px";

	var col_4 = document.createElement("Button");
	    col_4.class = "editPanel";
	    var txt = document.createTextNode(".col-4");
		col_4.appendChild(txt);
	    col_4.className = "tags";
		col_4.style.marginLeft="2px";
		
	var col_6 = document.createElement("Button");
	    col_6.class = "editPanel";
	    var txt = document.createTextNode(".col-6");
		col_6.appendChild(txt);
	    col_6.className = "tags";
		col_6.style.marginLeft="2px";
...
col_2.addEventListener("click",col2,false);
col_3.addEventListener("click",col3,false);
col_4.addEventListener("click",col4,false);
col_6.addEventListener("click",col6,false);
...
function changeTarget(){
    ...
    if(yourTarget.className == "container"){
	BSmenu.appendChild(row);
      }
	else if(yourTarget.className == "row" || yourTarget.parentNode.className == "row"){
	BSmenu.appendChild(col_2);
    BSmenu.appendChild(col_3);
    BSmenu.appendChild(col_4);
    BSmenu.appendChild(col_6);	
	}
	else 
...
function col2(e){
	if(yourTarget.className =="row"){
	var newElement = document.createElement("Div");
	    newElement.id = "new";
        var txt= document.createTextNode("new");
	    newElement.appendChild(txt);
		newElement.className ="col-md-2";
		newElement.style.border ="1px solid black";
	yourTarget.appendChild(newElement);
	yourTarget = newElement;
	changeTarget();}
	else {
	yourTarget.className ="col-md-2";
	changeTarget();
	}
	e.preventDefault();	
}
...
function col6(e){
	...
	var newElement = document.createElement("Div");
		...
		var txt= document.createTextNode("new");
	    newElement.appendChild(txt);
		newElement.className ="col-md-6";
		newElement.style.border ="1px solid black";
	yourTarget.appendChild(newElement);
	yourTarget = newElement;
	changeTarget();}
	else {
	yourTarget.className ="col-md-6";
	changeTarget();
	}
	e.preventDefault();	
}
